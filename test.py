...
from model import UMMENet
from utils import *

dataset = args.dataset
if dataset == 'sysu':
    data_path = '/home/datasets/reid/SYSU-MM01/'
    n_class = 395
    test_mode = [1, 2]
elif dataset == 'regdb':
    data_path = '/home/datasets/reid/RegDB/'
    n_class = 206
    test_mode = [2, 1]
...
if dataset == 'sysu':
    ...
    # model_path = './log/sysu_log/1690811227/sysu_adp_joint_co_nog_ch_nog_sq1_aug_G_erase_0.5_p4_n8_lr_0.01_seed_0_best.t'
    ...
    def get_model_path():
        model_dict = {}
        model_dir = './log/regdb_log/test/'
        for weight_dir in os.listdir(model_dir):
            weight_dir_path = os.path.join(model_dir, weight_dir)
            for weight in os.listdir(weight_dir_path):
                if 'best.t' in weight:
                    model_dict[weight] = os.path.join(weight_dir_path, weight)
        return model_dict
    ...
    for trial in range(trials):
        ...
        model_name = 'regdb_agw_aug_G_erase_0.5_p4_n8_lr_0.1_seed_0_trial_{}_best.t'.format(test_trial)
        # model_name = 'regdb_awg_aug_G_erase_0.5_p4_n8_lr_0.1_seed_0_trial_{}_best.t'.format(test_trial)
...
cmc = all_cmc / trials
mAP = all_mAP / trials
mINP = all_mINP / trials

cmc_pool = all_cmc_pool / trials
mAP_pool = all_mAP_pool / trials
mINP_pool = all_mINP_pool / trials
print('All Average:')
print(
    'FC:     Rank-1: {:.2%} | Rank-5: {:.2%} | Rank-10: {:.2%}| Rank-20: {:.2%}| mAP: {:.2%}| mINP: {:.2%}'.format(
        cmc[0], cmc[4], cmc[9], cmc[19], mAP, mINP))
